...
add statuses for other users besides admin
move filters for main inventory into controller
paginate like in the hackernews lab


plan presentation for avi. relevent pages:
...
record presentation and submit.
